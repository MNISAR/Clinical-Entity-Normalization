...
def find_defination_for_cui(cui):
    """
    ...
    content_endpoint = f"/rest/content/{version}/CUI/{cui}/definitions"
    pageNumber = 0
    
    result = ""
    while True:
        pageNumber += 1
        query = {'ticket':st, 'pageNumber':pageNumber, 'pageSize': 25}
