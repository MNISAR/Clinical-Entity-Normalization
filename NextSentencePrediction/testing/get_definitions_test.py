...
import pandas as pd
path = "C:/Users/monil/Desktop/BMI 598 - NLP/Project/2020AA/MRDEF.rrf"
...
count = 0
all_data = []
df = pd.read_csv("dataframe_with_candidate_cuis_test.csv")
for index in tqdm(df.index):
    if index%100 == 0:
        with open("all_data_test.pk", "wb") as f:
